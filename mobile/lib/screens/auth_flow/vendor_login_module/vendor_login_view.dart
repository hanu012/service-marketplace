...
class VendorLoginView extends StatelessWidget {
  ...
  Widget mainBody(VendorLoginController controller) {
    return Utils.authLayout(
      onSkipTap: null,
      title: StringRes.vendorLoginTitle,
      desc: StringRes.vendorLoginDesc,
      isLogin: true,
      isForCustomer: false,
      skipTap: false,
      contentWidget: Form(
  ...
  Widget getBottomButton(VendorLoginController controller, BuildContext context) {
    return Padding(
